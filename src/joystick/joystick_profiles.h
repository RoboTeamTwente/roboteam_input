...
const struct joystick_profile profile_default {
	...
	.DESCRIPTION = "DEFAULT",
    .ROTATION_MULTIPLIER = 0.07,   // Mutliplier      - Sets rotation speed/multiplier for relative mode
};
...
const struct joystick_profile profile_slow {
    ...
    .SPEED_MAX = 1.0,
	.DESCRIPTION = "SLOW",
    .ROTATION_MULTIPLIER = 0.04, // Mutliplier      - Sets rotation speed/multiplier for relative mode
};
...
const struct joystick_profile profile_quick {
    ...
    .SPEED_MAX = 5.6,
	.DESCRIPTION = "QUICK",
    .ROTATION_MULTIPLIER = 0.10,   // Mutliplier      - Sets rotation speed/multiplier for relative mode
};
